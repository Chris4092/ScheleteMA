...
class Top5VehiclesPage extends StatefulWidget {

  const Top5VehiclesPage({Key? key, required this.repo}) : super(key: key);

  final Repo repo;
  @override
  State<Top5VehiclesPage> createState() => _Top5VehiclesPageState(repo);
}

class _Top5VehiclesPageState extends State<Top5VehiclesPage> {
  ...
  Future<List<Vehicle>> initialiseEntitiesToLoad() async {
    List<Vehicle> entities = await repo.gettop5vehicles();
    return entities;
  }
  ...
  _Top5VehiclesPageState(this.repo);
        ...
        itemBuilder: (BuildContext ctxt, int index) {
          return GestureDetector(
            ...
            child: Card(
              ...
              child: Column(
                children: [
                  ListTile(title: Text(entities[index].license),subtitle: Text(entities[index].seats.toString())
                  )
                ],
              ),
            ),
